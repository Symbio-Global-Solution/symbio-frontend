        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-24">
            ...
            <p className="opacity-70 text-lg max-w-2xl mx-auto leading-relaxed">
              Nascemos da necessidade de fechar o gap entre o talento que as empresas têm e as habilidades que o futuro exige.
            </p>
          </div>

          <div className="text-center max-w-3xl mx-auto mb-32 space-y-8">
            <h2 className="text-3xl font-bold">
              Por que a <span className="text-symbio-purple">SYMBIO</span> existe?
            </h2>
            <p className="opacity-80 leading-relaxed text-lg text-gray-600 dark:text-gray-300">
              O mundo corporativo enfrenta um paradoxo: temos mais vagas abertas em tecnologia do que profissionais qualificados, ao mesmo tempo em que temos talentos internos estagnados por falta de direcionamento.
            </p>
            <p className="opacity-80 leading-relaxed text-lg text-gray-600 dark:text-gray-300">
              A <strong>Symbio</strong> surgiu para resolver essa equação. Criamos uma "simbiose" entre inteligência artificial e gestão de pessoas, identificando potenciais ocultos dentro da sua própria organização e sugerindo trilhas de aprendizado precisas.
            </p>
          </div>

          <div className="mb-32 relative">
             <div className="text-center mb-16">
                <h2 className="text-3xl font-bold mb-4">Como funciona a Simbiose?</h2>
                <p className="text-gray-500 dark:text-gray-400">Nosso processo em 4 etapas estruturadas.</p>
             </div>
             ...
             <div className="space-y-12">
               {steps.map((step, index) => (
                 <div key={step.id} className={`relative flex flex-col md:flex-row items-center gap-8 ${index % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
                   ...
                   <div className="absolute left-8 md:left-1/2 -translate-x-1/2 flex items-center justify-center w-16 h-16 rounded-full bg-white dark:bg-[#000010] border-4 border-gray-100 dark:border-[#2d1b3e] z-10 shadow-[0_0_20px_rgba(118,74,149,0.3)]">
                     <span className="text-xl text-symbio-purple dark:text-white">{step.icon}</span>
                   </div>
                   ...
                   <div className="w-full md:w-[45%] pl-20 md:pl-0">
                     <div className="bg-white/60 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 p-8 rounded-2xl hover:border-symbio-purple/50 transition-all duration-300 hover:-translate-y-1 group shadow-lg">
                       <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold text-white mb-3 ${step.color} bg-opacity-80`}>
                         PASSO 0{step.id}
                       </span>
                       <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-symbio-purple transition-colors">{step.title}</h3>
          ...
          <div className="mb-20">
            <h2 className="text-center text-3xl font-bold mb-12">Nossos Pilares</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {values.map((val, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-3 text-gray-800 dark:text-white">{val.title}</h3>
          ...
          <div className="text-center max-w-3xl mx-auto bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl p-10 relative overflow-hidden shadow-xl">
            ...
            <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">De onde viemos?</h2>
            <p className="opacity-80 leading-relaxed text-gray-600 dark:text-gray-300">
              A Symbio nasceu como um projeto acadêmico inovador na <strong>FIAP</strong>, desenvolvido por estudantes apaixonados por tecnologia e gestão. O que começou como um código em Python e Java, evoluiu para uma plataforma completa de Inteligência de Negócios e RH.
            </p>
          </div>
