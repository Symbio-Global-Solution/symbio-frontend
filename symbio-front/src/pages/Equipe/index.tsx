        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">
              Mentes por trás da <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-400">SYMBIO</span>
            </h1>
            ...
            {teamMembers.map((member) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-purple-600 dark:text-purple-400 text-sm font-medium mb-4">{member.role}</p>
                  
                  <div className="inline-block bg-page border border-themeBorder px-4 py-2 rounded-lg mb-6 text-sm opacity-90">
                    <p>RM: <span className="font-mono font-bold">{member.rm}</span></p>
                    <p>Turma: <span className="font-mono font-bold">{member.turma}</span></p>
                  </div>
